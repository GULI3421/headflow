      ...
      >
        <div className="container-shell">
          <div className="mb-8 flex flex-col justify-between gap-4 md:flex-row md:items-end">
            <div>
              <p className="text-sm font-black uppercase text-[#FF4F00]">Каталог</p>
              <h1 className="mt-2 text-4xl font-black leading-tight md:text-6xl">Оборудование для отопления</h1>
            </div>
            <p className="max-w-xl text-sm leading-6 text-black/58 dark:text-white/55 md:text-base">
              Подбирайте товары по категориям и подкатегориям из прайс-листа. Фильтры синхронизированы с Appwrite.
            </p>
          </div>
