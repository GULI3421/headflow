    ...
    <section className="relative overflow-hidden bg-white pt-28 text-slate-900 dark:bg-[#0a0a0a] dark:text-white md:pt-32">
      ...
      <div className="container-shell relative z-10 pb-20 pt-16 md:pb-28 md:pt-24">
        ...
        <div className="mt-12 grid gap-6 lg:grid-cols-[0.9fr_1.1fr] lg:gap-8">
          ...
          >
            {mounted && (
              <div className="h-[450px] w-full overflow-hidden rounded-3xl">
              <iframe
                src="https://widgets.2gis.com/widget?type=firms&options=%7B%22pos%22%3A%7B%22lat%22%3A42.898015%2C%22lon%22%3A74.594735%2C%22zoom%22%3A16%7D%2C%22city%22%3A%2270000001019344473%22%2C%22id%22%3A%2270000001019344473%22%7D"
                width="100%"
                height="100%"
                frameBorder="0"
